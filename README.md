...
Automatización E2E (UI &amp; API) para el sistema de reservas Shady Meadows utilizando Cypress y JavaScript. Incluye documentación de casos de prueba y reporte de bugs.
